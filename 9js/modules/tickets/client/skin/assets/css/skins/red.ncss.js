...
var result = {path:"client/skin/assets/css/skins/red.css",children:[]};
result.data = "body a {\n  color: #981b1b;\n}\nbody .profile-info.dropdown .dropdown-menu {\n  background: #981b1b;\n  border-color: #981b1b;\n}\nbody .profile-info.dropdown .dropdown-menu > li {\n  border-bottom-co" + 
 ...
 "#main-menu li#search .search-input:-moz-placeholder {\n  color: #f8e0e0;\n}\nbody .page-container .sidebar-menu #main-menu li#search .search-input::-moz-placeholder {\n  color: #f8e0e0;\n}\nbody .page" + 
 "-container .sidebar-menu #main-menu li#search .search-input:-ms-input-placeholder {\n  color: #f8e0e0;\n}\nbody #chat .chat-group > a {\n  color: #f8e0e0;\n}\nbody .conversation-body,\nbody #chat .ent" + 
