...
var result = {path:"client/skin/assets/css/skins/blue.css",children:[]};
result.data = "body a {\n  color: #003471;\n}\nbody .profile-info.dropdown .dropdown-menu {\n  background: #003471;\n  border-color: #003471;\n}\nbody .profile-info.dropdown .dropdown-menu > li {\n  border-bottom-co" + 
 ...
 "e-container .sidebar-menu #main-menu li a {\n  color: #bfccdb;\n}\nbody .page-container .sidebar-menu #main-menu li a:hover {\n  background-color: #084184;\n}\nbody .page-container .sidebar-menu #main" + 
 "-menu li ul > li > a:hover {\n  background-color: #052952;\n}\nbody .page-container.sidebar-collapsed .sidebar-menu #main-menu > li > ul li {\n  border-color: #063d7d;\n}\nbody .page-container .sideba" + 
 "r-menu #main-menu li ul > li ul > li > a {\n  background-color: #002a5a;\n}\nbody .page-container .sidebar-menu #main-menu li ul > li ul > li ul > li > a {\n  background-color: #002a5a;\n}\nbody .page" + 
 "-container .sidebar-menu #main-menu li ul > li ul > li ul > li ul > li > a {\n  background-color: #002a5a;\n}\nbody .page-container.sidebar-collapsed .sidebar-menu #main-menu > li > a > span:not(.badg" + 
 "e) {\n  background: #003471;\n  border-color: #063d7d;\n}\nbody .page-container.sidebar-collapsed .sidebar-menu #main-menu > li ul {\n  border-color: #063d7d;\n}\nbody .profile-info.dropdown .dropdown" + 
 ...
 "lor: #bfccdb;\n}\nbody.page-left-in,\nbody.page-right-in,\nbody.page-fade-only,\nbody.page-fade {\n  background: #003471 !important;\n}\nbody .page-container .sidebar-menu #main-menu li#search button " + 
 ...
 "in-menu li#search .search-input:-moz-placeholder {\n  color: #bfccdb;\n}\nbody .page-container .sidebar-menu #main-menu li#search .search-input::-moz-placeholder {\n  color: #bfccdb;\n}\nbody .page-co" + 
 "ntainer .sidebar-menu #main-menu li#search .search-input:-ms-input-placeholder {\n  color: #bfccdb;\n}\nbody #chat .chat-group > a {\n  color: #bfccdb;\n}\nbody .conversation-body,\nbody #chat .entypo" + 
 ...
 "at .chat-conversation .chat-textarea textarea:-moz-placeholder {\n  color: #bfccdb;\n}\nbody #chat .chat-conversation .chat-textarea textarea::-moz-placeholder {\n  color: #bfccdb;\n}\nbody #chat .cha" + 
 "t-conversation .chat-textarea textarea:-ms-input-placeholder {\n  color: #bfccdb;\n}\nbody .page-container.horizontal-menu header.navbar .navbar-nav > li ul li a {\n  color: #bfccdb;\n}\nbody .page-co" + 
 "ntainer.horizontal-menu header.navbar .navbar-inner > ul > li#search button i,\nbody .page-container.horizontal-menu header.navbar > ul > li#search button i {\n  color: #bfccdb;\n}\nbody .page-contain" + 
 "er.sidebar-collapsed .sidebar-menu #main-menu > li.has-sub:hover.has-sub > a:hover,\nbody .page-container.sidebar-collapsed .sidebar-menu #main-menu > li:hover.has-sub > a:hover {\n  color: #bfccdb;\n" + 
